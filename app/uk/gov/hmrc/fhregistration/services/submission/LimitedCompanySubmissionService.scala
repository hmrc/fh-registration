...
class LimitedCompanySubmissionService(countryCodeLookup: CountryCodeLookup) {


  val OrganizationType = "Corporate Body"

  val dtf: DateTimeFormatter = DateTimeFormatter.ofPattern("dd/MM/yyyy")

  def iformXmlToSubmission(xml: generated.limited.Data, brd: BusinessRegistrationDetails): SubScriptionCreate = {
    SubScriptionCreate(
      requestType = "Create",
