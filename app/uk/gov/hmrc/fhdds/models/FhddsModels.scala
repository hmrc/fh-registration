...
object FhddsModels {
  ...
  implicit val officerWriter = Json.writes[Officer]
  implicit val companyWriter = Json.writes[Company]
  implicit val companyDetailsWriter = Json.writes[CompanyDetails]
}
